...
public class LootLockerBoostTrap : MonoBehaviour
{
    public static bool SessionStarted { get; private set; }

    [SerializeField] string playerIdentifier = "1";

    private static LootLockerBoostTrap _instance;
    public static LootLockerBoostTrap Instance { get => _instance; set => _instance = value; }
    private void Awake()
    {
